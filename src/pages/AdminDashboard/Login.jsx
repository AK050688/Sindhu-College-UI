        ...
        <form action="" onSubmit={handleSubmit}>
          <div className="relative my-4">
            ...
            <input
              ...
              name="userName"
              value={userName}
              className="block w-72 py-2.3 px-0 text-sm text-white bg-transparent border-1  border-white appearance-none dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:text-white focus:border-blue-600 peer"
