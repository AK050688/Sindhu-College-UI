...
const AddTeacherTestModal = ({ onAddTeacherAssignment, setShowAddModal }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    const formDataWithExtras = {
      ...formData,
      testAddedBy: teacherName
    };
console.log(formDataWithExtras)
    try {
      const response = await axios.post(
        "https://university-project-paresh.onrender.com/University/TestRoute/addTest",
        formDataWithExtras,
        {
          headers: {
...
export default AddTeacherTestModal;
