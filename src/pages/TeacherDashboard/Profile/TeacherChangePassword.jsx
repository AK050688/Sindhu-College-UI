...
import style from "../../../styles/TeacherDashboard/TeacherChangePassword.module.css";
...
const TeacherChangePassword = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.put(
        "https://university-project-paresh.onrender.com/University/Teacher/changePassword-Teacher",
        formData,
        {
          headers: {
  ...
  return (
    <>
      <div
        className={`${style.background} ${style.teacherChangePasswordCOntainer}`}
      >
